<template>
  <div class="relative z-50 hidden w-1/2 lg:flex lg:justify-center">
    <svg
    ...
    >
      <defs></defs>
      <g id="Pingtung" class="group" @click="moveToArea('Pingtung')">
        <path
          id="161d6372-ac8f-409c-ad51-9db7795c8614"
          data-name="path2462"
          class="Pingtung cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'Pingtung' ? '#0284c7' : '#ffffff' }"
        />
        <path
      ...
      <g id="Penghu" class="group" @click="moveToArea('Penghu')">
        <path
          id="302f43cb-d765-4d82-8054-45eb380ec9ba"
          data-name="path2464"
          d="M74.57,416v0Z"
          :style="{ fill: mapStore.currentMapArea == 'Penghu' ? '#0284c7' : '#ffffff' }"
          class="Penghu cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
        />
        <path
      ...
      <g id="Yilan" class="group" @click="moveToArea('Yilan')">
        <path
          id="a79d6566-3a81-4189-bd0f-4dc972de6fa0"
          data-name="path2523"
          class="Yilan cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
          d="M559.38,143.41l1,.6.86-.09.17-1.12,1.21-.09,1.21.17.34,1.12,1.12.69-.43.69-1.12.43-2.5-.09-1.38-1.29-.52-1h0Z"
          :style="{ fill: mapStore.currentMapArea == 'Yilan' ? '#0284c7' : '#ffffff' }"
        />
        <path
      ...
      <g id="Taitung" class="group" @click="moveToArea('Taitung')">
        <path
          id="ae9239f1-7686-4c40-a5f8-f322391c7328"
          data-name="taitung_country"
          class="Taitung cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'Taitung' ? '#0284c7' : '#ffffff' }"
        />
        <path
      ...
      <g id="Chiayi">
        <path
          ...
          class="Chiayi cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'ChiayiCounty' ? '#0284c7' : '#ffffff' }"
          @click="moveToArea('ChiayiCounty')"
        />
        <path
          ...
          :style="{ fill: mapStore.currentMapArea == 'ChiayiCity' ? '#0284c7' : '#ffffff' }"
          @click="moveToArea('ChiayiCity')"
        />
      </g>
      <path
        id="30e45b59-571b-4340-a006-0ba62460619a"
        data-name="taichung_city"
        class="Taichung cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Taichung' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Taichung')"
      />
      <path
        id="21535635-db1e-4831-a63f-263ab3ed4b79"
        data-name="keelung_city"
        class="Keelung cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Keelung' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Keelung')"
      />
      <path
        id="1e48e0bb-8964-4121-b347-b900162cf771"
        data-name="taipei_city"
        class="Taipei cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Taipei' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Taipei')"
      />
      <path
        id="66958373-17e2-4fab-8b83-b16e2d323782"
        data-name="new_taipei_city"
        class="NewTaipei cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'NewTaipei' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('NewTaipei')"
      />
      <path
        id="65175d47-0a21-4bf1-abfb-b58e4d3069a0"
        data-name="taoyuan_country"
        class="Taoyuan cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Taoyuan' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Taoyuan')"
      />
      <g id="Hsinchu">
        <path
          id="350fa9bc-d25e-4c61-ae4b-b5c60b1a74b6"
          data-name="hsinchu_city"
          class="Hsinchu cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'HsinchuCity' ? '#0284c7' : '#ffffff' }"
          @click="moveToArea('HsinchuCity')"
        />
        <path
          id="ea41be52-3728-49f2-aa36-b90633ee55f6"
          data-name="hsinchu_county"
          class="Hsinchu cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'HsinchuCounty' ? '#0284c7' : '#ffffff' }"
          @click="moveToArea('HsinchuCounty')"
        />
      </g>
      <path
        id="ffd01e75-6ce2-4cfa-af98-bc61479c68ed"
        data-name="miaoli_country"
        class="Miaoli cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Miaoli' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Miaoli')"
      />
      <path
        id="d5701392-fc06-4411-bf79-2703f225ab2e"
        data-name="changhua_country"
        class="Changhua cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Changhua' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Changhua')"
      />
      <path
        id="4eed8214-870d-46ff-b77b-49234479d430"
        data-name="yunlin_country"
        class="Yunlin cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Yunlin' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Yunlin')"
      />
      <path
        id="e468a7aa-2bdf-4501-b48d-35483b7c8ccc"
        data-name="hualien_country"
        class="Hualien cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Hualien' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Hualien')"
      />
      <path
        id="7ed22330-8901-4fc6-a351-206f6b2daf2b"
        data-name="nantou_country"
        class="Nantou cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Nantou' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Nantou')"
      />
      <path
        id="0ce2847a-4f9c-4ff7-8c51-6b0fa24ba8b7"
        data-name="tainan_city"
        class="Tainan cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Tainan' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Tainan')"
      />
      <path
        id="e1806d87-d003-48dd-b8d3-3f99b3759340"
        data-name="kaohsiung_city"
        class="Kaohsiung cursor-pointer stroke-black duration-500 hover:translate-x-[-5px] hover:translate-y-[-5px]"
        ...
        :style="{ fill: mapStore.currentMapArea == 'Kaohsiung' ? '#0284c7' : '#ffffff' }"
        @click="moveToArea('Kaohsiung')"
      />
      <g id="Kinmen" data-name="kinmen_country" class="group" @click="moveToArea('Kinmen')">
        <path
          id="b83ee7c9-49c5-43e6-acea-f06d1c113084"
          data-name="path2643"
          class="Kinmen cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
          ...
          :style="{ fill: mapStore.currentMapArea == 'Kinmen' ? '#0284c7' : '#ffffff' }"
        />
        <path
      ...
      <g id="Lienchiang" data-name="g4313" class="group" @click="moveToArea('Lienchiang')">
        <path
          id="017d8352-40c4-43f3-b3c3-4910f7ad1925"
          data-name="path2671"
          class="Lienchiang cursor-pointer stroke-black duration-500 group-hover:translate-x-[-5px] group-hover:translate-y-[-5px]"
          d="M49,147.87h4.07L51.76,150l-3-.27.27-1.9Z"
          :style="{ fill: mapStore.currentMapArea == 'Lienchiang' ? '#0284c7' : '#ffffff' }"
        />
        <path
...
function moveToArea(area: string) {
  mapStore.currentMapArea = area
}
</script>
